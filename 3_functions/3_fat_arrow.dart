/// Kısa method Fat Arrow :
///  tek satırlık statement içeren methodlarımızı kısa bir şekilde göstermeye yarar.
...
void main(List<String> args) {
  ...
  print("Büyük olan sayı : ${maxOlaniBul(14, 9)}");

  print("Küçük olan sayı : ${minOlaniBul(14, 9)}");
}
