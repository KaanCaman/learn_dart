...
/// Eğer koşullar sağlanıyorsa veya sağlanmıyorsa belli kod bloklarının
/// çalıştırılmasını sağlamak için if yapısını kullanılır. Genel kullanım şekli şöyledir:
///
