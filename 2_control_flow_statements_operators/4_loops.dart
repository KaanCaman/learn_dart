///
/// Tekrar eden işlemler için döngülerden faydalanırız.
///  3 temel döngü çeşidi vardır, yapılan işlemler aynı olsada
/// kullanım amaçları farklılık gösterir.
///
/// for :
/// genellikle tekrar sayısı bilinen durumlarda kullanılır. yazım yöntemi şu şekildedir
///   for(
///        dongude_kullanilacak_kontrol_degiskeninin_baslangic_degeri ;
///        dongunun_bitme_sarti;
///        her_dongu_sonunda_yapilacak_islem
///     )
///   for(var i=0; i<10; i++)
///
...
///
/// while :
/// bir koşul doğru oldugu sürece yapılacak işlemler için kullanılan döngü çeşidi
///   while(sayac < 10){
///     yapılacak islem;
///     sayac ++;
///     }
///
/// do - while :
/// koşul sağlansın veya saglanmasın bir kere çalıştırılır ve sonra şart kontrol edilir.
/// do{
///   print("kaan");
///   i++
/// } while(i<10);
...
///
/// döngülerde label yani etiketler kullanılabilir.
/// Böylece birden fazla döngüyü bu etiketler ile kolayca kontrol edebiliriz.
...
main(List<String> args) {
  ...
  List isimListesi = ["kaan", "hasan", "ali"];
